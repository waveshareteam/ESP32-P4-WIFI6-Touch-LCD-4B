...
class AIChats: public systems::phone::App {
public:
    static AIChats *requestInstance(bool use_status_bar = false, bool use_navigation_bar = false);
    ~AIChats();

protected:
    AIChats(bool use_status_bar, bool use_navigation_bar);
...
private:
    ...
    std::atomic<XiaozhiProtocol *> _protocol{nullptr};
    ...
    void setChatMessage(XiaozhiProtocol::TextRole role, const char *text);
