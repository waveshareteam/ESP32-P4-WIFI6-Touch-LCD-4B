...
constexpr AppLauncherIcon::Data STYLESHEET_CUSTOM_APP_LAUNCHER_ICON_DATA = {
    .main = {
...
constexpr AppLauncherData STYLESHEET_CUSTOM_APP_LAUNCHER_DATA = {
    .main = {
        .y_start = 0,
    ...
    .table = {
        .default_num = 3,
        .size = gui::StyleSize::RECT_W_PERCENT(100, 580),
    },
    .indicator = {
    ...
    .icon = STYLESHEET_CUSTOM_APP_LAUNCHER_ICON_DATA,
    .flags = {
