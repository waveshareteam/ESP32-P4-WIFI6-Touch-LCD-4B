...
constexpr StatusBar::AreaData STYLESHEET_CUSTOM_STATUS_BAR_AREA_DATA(int w_percent, StatusBar::AreaAlign align)
{
    return {
...
constexpr StatusBar::Data STYLESHEET_CUSTOM_STATUS_BAR_DATA = {
    .main = {
    ...
    .area = {
        .num = 2,
        .data = {
            STYLESHEET_CUSTOM_STATUS_BAR_AREA_DATA(50, StatusBar::AreaAlign::START),
            STYLESHEET_CUSTOM_STATUS_BAR_AREA_DATA(50, StatusBar::AreaAlign::END),
        },
    },
