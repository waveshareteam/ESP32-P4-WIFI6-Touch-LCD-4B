...
constexpr RecentsScreenSnapshot::Data STYLESHEET_CUSTOM_RECENTS_SCREEN_SNAPSHOT_DATA = {
    .main_size = gui::StyleSize::RECT_PERCENT(40, 47),
    .title = {
        .main_size = gui::StyleSize::RECT_W_PERCENT(40, 16),
...
constexpr RecentsScreen::Data STYLESHEET_CUSTOM_RECENTS_SCREEN_DATA = {
    .main = {
        .y_start = 0,
    ...
    .snapshot_table = {
        ...
        .snapshot = STYLESHEET_CUSTOM_RECENTS_SCREEN_SNAPSHOT_DATA,
    },
    .trash_icon = {
