/*
 * microSD card read/write demo for the Waveshare ESP32-P4-WIFI6-Touch-LCD-4B.
 *
...
void setup() {
  ...
  const char *path = "/hello_lcd4b.txt";
  File f = SD_MMC.open(path, FILE_WRITE);
  if (!f) {
    Serial.println("Failed to open file for writing");
    return;
  }
  f.println("Hello from ESP32-P4-WIFI6-Touch-LCD-4B microSD demo!");
  f.close();
  Serial.println("Wrote /hello_lcd4b.txt");
