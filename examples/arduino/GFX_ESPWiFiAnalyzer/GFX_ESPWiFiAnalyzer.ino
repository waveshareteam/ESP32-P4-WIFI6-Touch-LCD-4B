...
#define WIFI_CHANNEL_COUNT (WIFI_CHANNEL_MAX - WIFI_CHANNEL_MIN + 1)

// Channel color mapping from channel 1 to 14
uint16_t channel_color[WIFI_CHANNEL_COUNT] = {
...
void loop() {
  uint8_t ap_count_list[WIFI_CHANNEL_COUNT] = { 0 };
  int32_t noise_list[WIFI_CHANNEL_COUNT];
  int32_t peak_list[WIFI_CHANNEL_COUNT];
  int16_t peak_id_list[WIFI_CHANNEL_COUNT];
  int32_t channel;
  int16_t idx;
  int32_t rssi;
  uint8_t *bssid;
