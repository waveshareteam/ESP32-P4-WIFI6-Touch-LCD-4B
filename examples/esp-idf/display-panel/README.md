...
Starts the Waveshare BSP 3.0.0 display stack with LVGL 9.3.0 and `espressif/esp_lvgl_adapter` 0.6.3, shows red/green/blue/white screens, then creates a full-screen LVGL touch area that draws black squares at GT911 touch positions.
