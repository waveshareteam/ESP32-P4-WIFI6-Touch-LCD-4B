...
class RepositoryPolicyTests(unittest.TestCase):
    ...
    def test_single_product_homepage_contract(self) -> None:
        ...
        self.assertIn('examples/arduino/libraries/displays/README_ZH.md', config)
        self.assertIn('examples/arduino/libraries/GFX_Library_for_Arduino/**', config)
        self.assertIn('examples/arduino/libraries/lvgl/**', config)
    ...
    def test_arduino_serial_startup_contract_ignores_comments_and_requires_short_bounds(self) -> None:
        ...
        self.assertIn("examples/arduino/examples/01_HelloWorld/01_HelloWorld.ino", inventory)
        self.assertIn(
    ...
    def test_first_party_inventory_covers_declared_maintained_surfaces(self) -> None:
        ...
        expected = {
            ...
            "examples/arduino/libraries/displays/README_ZH.md",
    ...
    def test_arduino_wrapper_pair_detects_missing_page_and_language_switches(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            root = Path(directory)
            wrapper = "examples/arduino/libraries/displays"
